...
class CurrentLocationViewController: UIViewController, CLLocationManagerDelegate, CAAnimationDelegate{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // Ocultamos navigation bar
        navigationController?.isNavigationBarHidden = true
    }
    
    override func viewWillDisappear(_ animated: Bool) {
        super.viewWillDisappear(animated)
        // Mostramos navigation bar
    ...
    func updateLabels() {
        if let location = location {
            latitudLabel.text = String(format: "%.8f", location.coordinate.latitude)
            longitudLabel.text = String(format: "%.8f", location.coordinate.longitude)
    ...
    func string(from placemark: CLPlacemark) -> String {
        var line1 = ""
        line1.add(text: placemark.subThoroughfare, separetedBy: "")
        line1.add(text: placemark.subThoroughfare, separetedBy: " ")
        
        var line2 = ""
        line2.add(text: placemark.locality, separetedBy: "")
